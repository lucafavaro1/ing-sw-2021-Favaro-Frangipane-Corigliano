...
public class MarketTray {
    ...
    public String toString() {
        return "\nBiglia libera: " + getFreeball() + "\n" +
                ...
                " \n 1: " + "[" +
                 getRow(0).get(0) + getSpaces(0,0) +  "]" + "[" +
                 getRow(0).get(1) + getSpaces(0,1) + "]" + "[" +
                 getRow(0).get(2) + getSpaces(0,2) + "]" + "[" +
                 getRow(0).get(3) + getSpaces(0,3) + "]" + " \n 2: " + "[" +
                 getRow(1).get(0) + getSpaces(1,0) + "]" + "[" +
                 getRow(1).get(1) + getSpaces(1,1) + "]" + "[" +
                 getRow(1).get(2) + getSpaces(1,2) + "]" + "[" +
                 getRow(1).get(3) + getSpaces(1,3) + "]" + " \n 3: " + "[" +
                 getRow(2).get(0) + getSpaces(2,0) + "]" + "[" +
                 getRow(2).get(1) + getSpaces(2,1) + "]" + "[" +
                 getRow(2).get(2) + getSpaces(2,2) + "]" + "[" +
                 getRow(2).get(3) + getSpaces(2,3) + "]";
    }
